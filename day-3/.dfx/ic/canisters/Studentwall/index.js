...
export const canisterId = process.env.STUDENTWALL_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Studentwall.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Studentwall canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Studentwall.did.js")._SERVICE>}
 */
