...
import { idlFactory } from './MotoCoin.did.js';
export { idlFactory } from './MotoCoin.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MOTOCOIN_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./MotoCoin.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the MotoCoin canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./MotoCoin.did.js")._SERVICE>}
 */
export const MotoCoin = createActor(canisterId);
