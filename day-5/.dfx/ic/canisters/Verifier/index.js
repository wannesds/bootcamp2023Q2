...
import { idlFactory } from './Verifier.did.js';
export { idlFactory } from './Verifier.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.VERIFIER_CANISTER_ID;
...
/**
 * A ready-to-use agent for the Verifier canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Verifier.did.js")._SERVICE>}
 */
export const Verifier = createActor(canisterId);
