...
export { idlFactory } from './Calculator.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CALCULATOR_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Calculator.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Calculator canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Calculator.did.js")._SERVICE>}
 */
export const Calculator = createActor(canisterId);
